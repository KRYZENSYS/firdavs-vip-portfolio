...
export default function Projects() {
  ...
  // Trigger Konami badge unlock
  useEffect(() => {
    const handler = () => addBadge("konami-master");
    window.addEventListener("fvip-konami-fired", handler);
    return () => window.removeEventListener("fvip-konami-fired", handler);
  }, [addBadge]);
